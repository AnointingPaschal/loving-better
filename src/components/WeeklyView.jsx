...
const SECTIONS = [
  {
    id: 'him', title: 'His weekly work', emoji: '👨🏾', items: WEEKLY_HIM,
    colorClass: 'rose', accentColor: '#C0556A', bgColor: '#FFF5F7',
    noteKey: 'weekly_him',
  },
  {
    id: 'her', title: 'Her weekly work', emoji: '👩🏾', items: WEEKLY_HER,
    colorClass: 'sage', accentColor: '#5A7A6E', bgColor: '#F5FAF8',
    noteKey: 'weekly_her',
  },
  {
    id: 'both', title: 'Together this week', emoji: '💛', items: WEEKLY_BOTH,
    ...
    <>
      ...
      {allDone && (
        <div className="complete-badge">
          🎉 Full week complete — this is what building looks like!
        </div>
      )}
