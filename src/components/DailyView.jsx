...
const SECTIONS = [
  { id: 'him',  title: 'His daily work',     emoji: '👨🏾', items: DAILY_HIM,  colorClass: 'rose', accentColor: '#C0556A', bgColor: '#FFF5F7', noteKey: 'daily_him' },
  { id: 'her',  title: 'Her daily work',     emoji: '👩🏾', items: DAILY_HER,  colorClass: 'sage', accentColor: '#5A7A6E', bgColor: '#F5FAF8', noteKey: 'daily_her' },
  { id: 'both', title: 'Together every day', emoji: '💛',   items: DAILY_BOTH, colorClass: 'gold', accentColor: '#B8860B', bgColor: '#FFFBF0', noteKey: 'daily_both' },
];
...
export default function DailyView({ checked, onToggle, notes, onNote }) {
  ...
  return (
    <>
      ...
      {allDone && (
        <div className="complete-badge">🎉 All daily tasks complete — well done both of you!</div>
      )}
